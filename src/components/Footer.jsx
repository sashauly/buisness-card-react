      ...
      <ul className="list-reset footer__list">
        {props.twitter && (
          <li className="footer__item">
            <a aria-label="twitter" href={`${props.twitter}`}>
        ...
        {props.facebook && (
          <li className="footer__item">
            <a aria-label="facebook" href={`${props.facebook}`}>
        ...
        {props.instagram && (
          <li className="footer__item">
            <a aria-label="instagram" href={`${props.instagram}`}>
        ...
        {props.telegram && (
          <li className="footer__item">
            <a aria-label="telegram" href={`${props.telegram}`}>
        ...
        {props.github && (
          <li className="footer__item">
            <a aria-label="github" href={`${props.github}`}>
